const APPS = [
  { id: "war-markets", label: "Money + War", href: "https://war-markets.options-dashboard.duckdns.org/" },
  { id: "capex", label: "AI Capex", href: "https://war-markets.options-dashboard.duckdns.org/capex/" },
